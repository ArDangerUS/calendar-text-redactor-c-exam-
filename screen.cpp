...
Screen::Screen(const Screen& other)
    ...
    std::cout << "Screen copy constructor invoked" << std::endl;
}
...
Screen::Screen(Screen&& other) noexcept
    ...
    linesPerScreen(other.linesPerScreen) {
    other.position = 0;
    std::cout << "Screen move constructor invoked" << std::endl;
}
...
Screen& Screen::operator=(const Screen& other) {
    ...
    std::cout << "Screen copy assignment operator invoked" << std::endl;
    return *this;
}
...
Screen& Screen::operator=(Screen&& other) noexcept {
    ...
    std::cout << "Screen move assignment operator invoked" << std::endl;
    return *this;
}
